...
_LAZY: dict[str, str] = {
    ...
    "adjudicate": "app.agents.epistemics",
    "adjudicate_all": "app.agents.epistemics",
    "classify_conflict": "app.agents.epistemics",
    "classify_claim": "app.agents.epistemics",
    "assess_standards": "app.agents.epistemics",
    "coverage_asymmetry": "app.agents.epistemics",
    "ClaimType": "app.agents.epistemics",
    "ConflictKind": "app.agents.epistemics",
    "Resolution": "app.agents.epistemics",
    "EVIDENCE_STANDARDS": "app.agents.epistemics",
    "apply_epistemic_adjustments": "app.agents.confidence",
    # sources / evidence
